...
public class CameraSettings : MonoBehaviour
{
    ...
    void Start() 
    {
        ...
        BluetoothWindow.OnQRCodeStartCamera += OnQRCodeStartCamera;
        BluetoothWindow.OnQRCodeStopCamera += OnQRCodeStopCamera;
    }   
    void OnDestroy()
    {
        BluetoothWindow.OnQRCodeStartCamera -= OnQRCodeStartCamera;
    ...
    void OnQRCodeStartCamera()
    {
        CameraDevice.Instance.Stop();
        CameraDevice.Instance.Deinit();
     
    }
    void OnQRCodeStopCamera()
    {
        CameraDevice.Instance.Init(CameraDevice.Instance.GetCameraDirection());
